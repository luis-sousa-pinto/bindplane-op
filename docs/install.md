...
Agents can be installed via the BindPlane web interface or manually. The manual approach could be implemented
...
Copy the command generated by the web interface, and run it on the system you wish to install the agent on.

After running the agent install command, the agent will appear in the web interface under the Agents tab.
...
Copy the output and run the command on the system your wish to install the agent on.

After running the agent install command, the agent will appear in the `bindplane get agents` output.
...
a more flexible approach to installation.

The steps documented here can be used as a starting point if implementing agent installation
with configuration management. 

#### Linux

Follow the [agent installation guide](https://github.com/observIQ/bindplane-agent/blob/main/docs/installation-linux.md).
...
Once the agent is restarted, it will connect to BindPlane and appear in the list of agents. BindPlane will preserve the agent's
existing configuration.

#### Windows

Follow the [agent installation guide](https://github.com/observIQ/bindplane-agent/blob/main/docs/installation-windows.md).
