...
type mockConstructorTestingTNewMockConnections interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockConnections[S interface{}](t mockConstructorTestingTNewMockConnections) *MockConnections[S] {
