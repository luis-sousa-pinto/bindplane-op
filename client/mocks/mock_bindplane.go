...
import (
	...
	version "github.com/observiq/bindplane-op/internal/version"
)
...
func (_m *MockBindPlane) Agents(ctx context.Context, options ...client.QueryOption) ([]*model.Agent, error) {
	...
	var r0 []*model.Agent
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ...client.QueryOption) ([]*model.Agent, error)); ok {
		return rf(ctx, options...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ...client.QueryOption) []*model.Agent); ok {
		r0 = rf(ctx, options...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*model.Agent)
	...
	if rf, ok := ret.Get(1).(func(context.Context, ...client.QueryOption) error); ok {
		r1 = rf(ctx, options...)
	} else {
		r1 = ret.Error(1)
	}
